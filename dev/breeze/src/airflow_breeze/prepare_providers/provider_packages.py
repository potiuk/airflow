...
from airflow_breeze.utils.path_utils import AIRFLOW_PROVIDERS_SRC_DIR, AIRFLOW_SOURCES_ROOT
...
def copy_provider_sources_to_target(provider_id: str) -> Path:
    ...
    source_provider_sources_path = get_old_base_package_path(provider_id)
    relative_provider_path = source_provider_sources_path.relative_to(AIRFLOW_PROVIDERS_SRC_DIR)
