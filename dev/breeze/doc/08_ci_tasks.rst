...
CI dependencies. This command updates pre-commit hooks, chart dependencies, and other critical CI environment
...
You can optionally provide a Slack webhook URL to receive notifications when a PR is created.
