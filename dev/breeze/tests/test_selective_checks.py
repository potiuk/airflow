        ...
        (
            pytest.param(
                ...
                "main",
                {
                    ...
                    "kubernetes-combos-list-as-string": "3.8-v1.28.15 3.9-v1.29.12 3.10-v1.30.8 3.11-v1.31.4 3.12-v1.32.0",
                    "ci-image-build": "true",
                    "prod-image-build": "true",
                    "run-tests": "true",
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            {
                "selected-providers-list-as-string": "amazon common.io common.sql dbt.cloud ftp google mysql openlineage postgres sftp snowflake trino",
                "all-python-versions": "['3.8']",
                "all-python-versions-list-as-string": "3.8",
                "ci-image-build": "true",
                "prod-image-build": "false",
                ...
                "test-groups": "['core', 'providers']",
                "docs-build": "true",
                "docs-list-as-string": "apache-airflow amazon common.io common.sql dbt.cloud ftp google mysql openlineage postgres sftp snowflake trino",
                ...
                "upgrade-to-newer-dependencies": "false",
                "core-test-types-list-as-string": "API Always CLI Core Operators Other Serialization WWW",
                "providers-test-types-list-as-string": "Providers[amazon] Providers[common.io,common.sql,dbt.cloud,ftp,mysql,openlineage,postgres,sftp,snowflake,trino] Providers[google]",
                "needs-mypy": "false",
                "mypy-checks": "[]",
            },
