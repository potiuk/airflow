...
class BaseOperator(Operator, LoggingMixin):
    ...
    def priority_weight_total(self) -> int:
        ...
        if not self._dag:
            raise AirflowException("Dag should be set before priority weight calculation.")
    ...
    def get_flat_relative_ids(self,
        ...
        if not self._dag:
            raise AirflowException("Dag should be set before relative_ids calculation.")
    ...
    def get_flat_relatives(self, upstream: bool = False):
        ...
        """
        if not self._dag:
            raise AirflowException("Dag should be set before get_flat_relatives calculation.")
        from airflow import DAG
        dag: DAG = self._dag
    ...
    def _set_relatives(self,
        ...
        for task in task_list:
            ...
            # noinspection Pylint
            if not task._dag:  # pylint: disable=protected-access
                raise AirflowException("Dag should be set before _set_relatives; received {}.".
