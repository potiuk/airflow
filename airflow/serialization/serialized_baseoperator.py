...
from airflow.serialization.serialization_base import SerializationBase


class SerializedBaseOperator(BaseOperator, SerializationBase):
    ...
    def serialize_operator(cls, op: BaseOperator) -> dict:
        ...
        """
        return cls.serialize_to_json(op, cls._decorated_fields)
