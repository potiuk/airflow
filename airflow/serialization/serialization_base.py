...
class SerializationBase:
    """SerializationBase provides utils for serialization."""
    ...
    @classmethod
    def from_json(cls, serialized_obj: str) -> Union['SerializationBase', dict, list, set, tuple]:
        """Deserializes json_str and reconstructs all DAGs and operators it contains."""
        return cls.from_dict(json.loads(serialized_obj))

    @classmethod
    def from_dict(cls, serialized_obj: dict) -> Union['SerializationBase', dict, list, set, tuple]:
