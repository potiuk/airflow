...
.. code-block:: bash
    ...
    ./breeze tests tests/test_core.py::TestCore --db-reset
...
.. code-block:: bash
     ...
     ./breeze --test-type Core tests --db-reset

Runs all provider tests:

.. code-block:: bash

     ./breeze --test-type Providers tests --db-reset

* Special kinds of tests - Integration, Heisentests and Quarantined which are marked with pytest
  marks and for those you need to select the type using test-type switch. If you want to run such test
