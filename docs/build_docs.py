...
parser.add_argument('--disable-spell-check', dest='disable_spell_check', action='store_true',
                    help='Disable spell checking')
parser.add_argument('--disable-docs-build', dest='disable_docs_build', action='store_true',
                    help='Disable building docs')
